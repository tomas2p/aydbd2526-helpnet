...
> 
> 1. `ddl_helpnet.sql`: Primero se debe crear la estructura.
> 2. `data_insert.sql` (o `dml_helpnet.sql`): Carga masiva de datos iniciales.
> 3. `triggers.sql`: Activación de las reglas de negocio.
> 
> **¿Por qué este orden?**
> 
